      ...
      <div class="row">
        <div class="col-12">
          <div class="login-card">
            <div>
              <div><a class="logo" href="{$urlApp}"><img class="img-fluid for-light" src="assets/images/logo/logo-login.png" alt="looginpage"><img class="img-fluid for-dark" src="assets/images/logo/logo_dark.png" alt="looginpage"></a></div>
              <div class="login-main">
                <form class="theme-form hideThis" method="POST" action="<?php echo URLAPP . 'user/register'?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-row">
                      <div class="col-6">
                        <input class="form-control" type="text" name="login[nome_usuario]" required="" placeholder="Nome">
                      </div>
                      <div class="col-6">
                        <input class="form-control" type="text" name="login[sobrenome_usuario]" required="" placeholder="Sobrenome">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-form-label">Telefone</label>
                    <input class="form-control" type="text" name="login[telefone_usuario]" required="" placeholder="(99) 99999-9999">
                  </div>
                  <div class="form-group">
                    <label class="col-form-label">Endereço de e-mail</label>
                    <input class="form-control" type="email" name="login[email_usuario]" required="" placeholder="seu@email.com">
                  </div>
                  <div class="form-group">
