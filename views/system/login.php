...
<html lang="en">
  <head>
    ...
    <title>Login <?php echo TITLEAPP;?></title>
    <!-- Google font-->
          ...
          <div class="login-card">
            <div>
              ...
              <div class="login-main">
                <form class="theme-form" method="POST" action="<?php echo URLAPP . 'user/auth'?>">
                  ...
                  <div class="form-group mb-0">
                    <div class="checkbox p-0">
                      <input id="checkbox1" type="checkbox" value="sim" name="login[termos]">
                      <label class="text-muted" for="checkbox1">Lembrar dados</label>
                    </div><a class="link" href="<?php echo URLAPP . 'user/new-pwd'?>">Esqueceu a senha?</a>
                  ...
                  <p class="mt-4 mb-0">Novo usuário?<a class="ml-2" href="<?php echo URLAPP . 'user/new'?>">criei sua conta grátis</a></p>
                </form>
              </div>
            </div>
          </div>
