    ...
    <div class="main" style="margin:30px auto;max-width: 650px;">
        ...
        <div class="bodyContent">
            ...
            <div class="mailHeader">
              <h2>Senha de Acesso Temporária!</h2>
              <p><strong class="userName">Olá, {%emailUsuario%}.</strong></p>
            </div>
            
            <div class="mailBody">
              <p>
              Você esta recebendo esta mensagem porque em {%dataSolicitacao%} você solicitou a recuperação de sua senha de acesso.
              <br />
              <br />
              Utilize a senha abaixo para realizar seu acesso: 
              <br />
              <br />
              <h2>
              <span style="border:1px #000 dashed;padding:10px;clear:both;font-size:22pt;">
              {%senhaTemporaria%}
              </span>
              </h2>
              </p>
              <p>
              <br />
              <span style="color:red;">Depois de logado altere sua senha provisória no link <a href="{%linkMeuPerfil%}">Meu Perfil</a>.</span>
              <br />
              <br />
              ...
              <p  class="footerNotes">
                <small>
                  <b>NOTAS:</b> Caso você desconfie desta notificação nos comunique. Por favor não responda este email, esta é uma mensagem automática e não será respondida. Para falar com nosso atendimento envie sua mensagem para o email <a href="mailto:{%mailSuporte%}">{%mailSuporte%}</a></small></p>
            </div>
