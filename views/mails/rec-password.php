              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <br />
                    <p style="text-align: center"><a href="{%linkRecuperacao%}" style="padding: 10px; background-color: #0866E2; color: #fff; display: inline-block; border-radius: 4px">RECUPERAR MINHA SENHA DE ACESSO!</a>
                    </p>
                    <br />
                    <br />
