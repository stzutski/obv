  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="error-wrapper">
        <div class="container"><img class="img-100" src="res/assets/images/other-images/sad.png" alt="">
          <div class="error-heading">
            <h2 class="headline font-success">404</h2>
          </div>
          <div class="col-md-8 offset-md-2">
            <p class="sub-content">O recurso solicitado não existe ou você não tem permissão de acessar!</p>
          </div>
          <div><a class="btn btn-success-gradien btn-lg" href="{$urlApp}">Voltar</a></div>
        </div>
      </div>
      <!-- error-403 end-->
    </div>
